...
import { BadgeCheck, LayoutGrid, DoorOpen, Users, Receipt, Shield, Wrench } from 'lucide-react';
...
const navItems = [
    ...
    { title: 'Verification', href: '/admin/verification-requests', icon: BadgeCheck },
